...
<div class="single-property-content">
        ...
        <div class="content">
          ...
          <?php if ($available_retail_space) { ?>
            <div class="detail">
              ...
              <div class="value" id="space-available" data-space-available="<?php echo $available_retail_space; ?>">
                <?php echo $available_retail_space; ?>
              </div>
            </div>
          <?php } ?>
  ...
  <?php if ($lat_long && $api_key) { ?>
    <div class="content-container map-content">
      <script src="https://maps.googleapis.com/maps/api/js?key=<?php echo $api_key; ?>&libraries=marker&loading=async&callback=Function.prototype"></script>
      <div id="property-map" data-lat="<?php echo $lat_long->lat; ?>" data-lng="<?php echo $lat_long->lng; ?>"></div>
    </div>
  <?php } ?>
      ...
      <?php if ($media_gallery) { ?>
        <?php foreach ($media_gallery as $media) {
          if ($media['thumbnail']) {
            ...
            ?>
            <div class="gallery-image-wrapper">
              <div <?php echo $video_string; ?> style="background-image: url(<?php echo $media['thumbnail']['url']; ?>);"
...
<script>
  window.addEventListener('spectra_init', function (e) {
    const propSpace = {
     'space_available': "<?php echo $available_retail_space; ?>" 
    };
